...
#ifndef PROGRAM4_OTP_DEC_D_UTILITIES_H
#define PROGRAM4_OTP_DEC_D_UTILITIES_H
...
int decode();
int sendPlaintext(int);
void createSignalHandler();

#endif //PROGRAM4_OTP_DEC_D_UTILITIES_H
